 ...
 *			Single character is updated in the displayed string.
 *			When first keypad button is pressed, it changes the first character to the corresponding character.
 *			Second keypad press changes the second character to the corresponding button press.
 *			etc.
 *
 *	I acknowledge all content contained herein, excluding template or example
 *	code, is my own original work.
 *
 *	Video link: https://youtu.be/uKceMMpqVNE
 */
#include <avr/io.h>
#ifdef _SIMULATE_
...
unsigned char ind = 0;
enum ledDisplay_States { ldStart, ldWait, ledDisplay1, ledDisplay2 };
...
int main(void) {
	...
	LCD_init();
	LCD_DisplayString(1, "Chicken Nuggets!");
